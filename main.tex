...
\cvevent{Ph.D. in Bioengineering \small{(submitted)}}{University of Auckland}{Dec 2021 - May 2025}{Auckland, New Zealand}  
...
\begin{itemize}
    \item \textbf{Languages \& Frameworks:} Python (Flask, Django, Pytorch, Keras), Java (Spring Boot), Ballerina, Bash
    ...
    \item \textbf{Specialized Expertise:} Deep Learning (Vision, NLP \& signal processing)
\end{itemize}
